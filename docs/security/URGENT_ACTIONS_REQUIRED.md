...
2. Find your Render API key (starts with `rnd_`) and revoke it
...
9. Copy new token (format: `123456789:ABCdefGHI...`) — DO NOT commit this token to source control
...
5. Find your Trigger.dev API key (starts with `tr_dev_`) and revoke it
